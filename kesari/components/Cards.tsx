...
Replace 'Action 1' with a descriptive label like 'Learn More' or 'Add to Cart', depending on the button's functionality. Replace 'Action 2' with a more intuitive label such as 'Skip' or 'Not Now'.
